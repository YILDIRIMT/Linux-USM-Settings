...
echo -e "\033[31m HATA: Masaüstü dizini bulunamadı ~/USM-S/kullanici_olustur.sh dosyasının içindeki DESKTOP(3) değer kısmını masaüstü konumunuzu işaretleyecek şekilde değiştirin. \033[0m"
